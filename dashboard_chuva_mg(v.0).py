...
def main():
    m = leafmap.Map(center=[-21.5, -45.75],zoom=6,width=1500,height=775,draw_control=False, measure_control=False, fullscreen_control=False, attribution_control=True)
