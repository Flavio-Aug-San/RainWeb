...
def main():
    ...
    m = leafmap.Map(center=[-21.5, -45.75],zoom=20, width=10000,height=700,draw_control=False, measure_control=False, fullscreen_control=False, attribution_control=True)
