...
def main():
   ...
   m = leafmap.Map(center=[-21.5, -45.75], zoom=20, width='100%', height='100%',draw_control=False, measure_control=False,fullscreen_control=True, attribution_control=True)
